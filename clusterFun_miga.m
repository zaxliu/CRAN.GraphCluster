function [clusters,fval] = clusterFun_miga(nodeName,nodeComp,Adj,seed,params)
...
%     InitPop = repmat(reshape(repmat((1:6),10,1),1,60),popSize,1); % fully distributed
    ...
    %% Genetic algorithm
%     rng(2,'twister') % seeding for random number generator, uncomment if want to reproduce result
