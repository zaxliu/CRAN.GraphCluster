...
params.linkWeight1 = [1, 0.9*1, 0.9*4/30/2, 0.81*4/30/2,...
                        0.81*4/30/2, 0.9*4/30/2, 0.9*1, 1];   % Weighting rule between links
...
%% Cluster, cost
[clusters,fval] = clusterFun(nodeName,nodeComp,Adj,seed,params);
disp(fval);
